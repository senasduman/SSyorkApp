                    ...
                    <div class="flex flex-col items-start gap-6 md:flex-row md:items-center">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="flex gap-4">
                                ...
                                @if(!$isOwnProfile)
                                    <button class="inline-flex items-center px-6 py-3 font-semibold text-white transition-colors rounded-lg opacity-50 cursor-not-allowed"
                ...
                <div class="p-6">
                    <div class="flex flex-wrap gap-2 mb-6">
                        ...
                        <button onclick="showSection('liked-playlists')" id="tab-liked-playlists" class="px-4 py-2 text-sm font-medium rounded-lg tab-button">
                            ❤️ Liked ({{ $user->likedPlaylists->count() }})
                        </button>
                        @if($user->is_artist)
                        ...
                        <button onclick="showSection('following')" id="tab-following" class="px-4 py-2 text-sm font-medium rounded-lg tab-button">
                            ➡️ Following ({{ $user->following_count }})
                        </button>
                    </div>
                    ...
                    <div id="section-playlists">
                        <div class="flex items-center justify-between mb-6">
                            <h2 class="flex items-center text-2xl font-bold" style="color: var(--text-primary);">
                                ...
                                {{ $isOwnProfile ? 'Your' : $user->name . "'s" }} Playlists
                            </h2>
                        </div>
                        ...
                        @else
                            <div class="py-16 text-center">
                                ...
                                <p style="color: var(--text-secondary);">
                                    {{ $isOwnProfile ? 'Create your first playlist to organize your music!' : 'This user hasn\'t created any playlists yet.' }}
                                </p>
                            </div>
                        @endif
                    </div>
                    ...
                    <div id="section-liked-playlists" class="section-hidden">
                        <div class="flex items-center justify-between mb-6">
                            <h2 class="flex items-center text-2xl font-bold" style="color: var(--text-primary);">
                                ...
                                {{ $isOwnProfile ? 'Your' : $user->name . "'s" }} Liked Playlists
                            </h2>
                        </div>

                        @if($user->likedPlaylists->count() > 0)
                            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                                @foreach ($user->likedPlaylists as $playlist)
                        ...
                        @else
                            <div class="py-16 text-center">
                                ...
                                <p style="color: var(--text-secondary);">
                                    {{ $isOwnProfile ? 'Start exploring and like playlists to see them here!' : 'This user hasn\'t liked any playlists yet.' }}
                                </p>
                                @if($isOwnProfile)
                                    <a href="{{ route('playlists.index') }}"
                                       class="inline-flex items-center gap-2 px-6 py-3 mt-4 font-semibold text-white transition-all duration-300 rounded-xl"
                                       style="background: var(--accent-color);">
                    ...
                    @if($user->is_artist)
                        <div id="section-albums" class="section-hidden">
                            <div class="flex items-center justify-between mb-6">
                                <h2 class="flex items-center text-2xl font-bold" style="color: var(--text-primary);">
                                    <span class="mr-3 text-3xl">🎼</span>
                                    {{ $isOwnProfile ? 'Your' : $user->name . "'s" }} Albums
                                </h2>
                            </div>
                            ...
                            @else
                                <div class="py-16 text-center">
                                    ...
                                    <p style="color: var(--text-secondary);">
                                        {{ $isOwnProfile ? 'Upload your first album to share your music with the world!' : 'This artist hasn\'t released any albums yet.' }}
                                    </p>
                                </div>
                            @endif
                        </div>
                    ...
                    <div id="section-followers" class="section-hidden">
                        ...
                        @else
                            <div class="py-16 text-center">
                                ...
                                <p style="color: var(--text-secondary);">{{ $isOwnProfile ? 'When people follow you, they\'ll appear here.' : 'This user doesn\'t have any followers yet.' }}</p>
                            </div>
                        @endif
                    </div>
                    ...
                    <div id="section-following" class="section-hidden">
                        ...
                        @else
                            <div class="py-16 text-center">
                                ...
                                <p style="color: var(--text-secondary);">{{ $isOwnProfile ? 'Discover new artists and follow them to see their content here.' : 'This user isn\'t following anyone yet.' }}</p>
                            </div>
                        @endif
                    </div>
                </div>
